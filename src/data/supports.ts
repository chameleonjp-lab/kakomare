...
export const SUPPORTS: Record<SupportId, SupportDefinition> = {
  ...
  reserve: {
    id: 'reserve', name: '蓄勢環', description: '蓄圧槍の再発射間隔を少し短くします。ほかの武器の蓄積や放出は変えません。', role: '蓄圧槍の再発射間隔短縮', color: 0xeab308, maxLevel: 3,
    levels: [{ value: 1, secondaryValue: 0.08, label: '蓄圧槍の再発射間隔を最大0.08秒短縮' }, { value: 2, secondaryValue: 0.14, label: '蓄圧槍の再発射間隔を最大0.16秒短縮' }, { value: 3, secondaryValue: 0.22, label: '蓄圧槍の再発射間隔を最大0.24秒短縮' }],
  },
  lattice: {

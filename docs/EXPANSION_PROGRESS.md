...
- `tests/unit/spawn-and-simulation.test.ts` にLv10以降の敵供給回帰、`tests/e2e/core.spec.ts` に強化画面の最下部スクロールと再読込復帰の回帰を追加した。lint、typecheck、単体・結合、E2E、build、配布物検査、独立レビューは未完了であり、成功扱いにしない。
